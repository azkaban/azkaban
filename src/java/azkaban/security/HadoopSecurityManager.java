...
public abstract class HadoopSecurityManager {
	 ...
	 */
	public abstract UserGroupInformation getProxiedUser(String toProxy) throws SecurityManagerException;
	
	/**
	* Create a proxied user, taking all parameters, including which user to proxy
	* from provided Properties.
	*/
	public abstract UserGroupInformation getProxiedUser(Props prop) throws SecurityManagerException;
	
	public abstract FileSystem getFSAsUser(String user) throws SecurityManagerException;
	...
	public abstract void prefetchToken(File tokenFile, String userToProxy) throws SecurityManagerException;
