...
public class AzkabanClient {
    ...
    public AzkabanClient(String url, String username, String password, int retries) throws Exception {
    ...
    public FlowExecutions getFlowExecutions(String projectName, String flowName,
                                            int length) throws IOException, URISyntaxException {
