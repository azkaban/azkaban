...
public class TokenFetcher {
   ...
   */
  private static void fillValuesThatEnableTokenFetching(Props props)
  {
   ...
   */
  private static HadoopSecurityManager loadHadoopSecurityManager(Props props, Logger log)
   ...
   * OBTAIN_BINARY_TOKEN
   */
  TokenFetcher(Props sysProps, Props jobProps, Logger logger) {
    boolean shouldProxy = sysProps.getBoolean(HadoopSecurityManager.ENABLE_PROXYING, false);
    boolean obtainTokens = sysProps.getBoolean(HadoopSecurityManager.OBTAIN_BINARY_TOKEN, false);
   ...
   */
  public static File writeTokensToTempFile(HadoopSecurityManager hadoopSecurityManager, Props props,
   ...
   */
  public @Nullable File createTokenFile(Props props, final Logger logger)
      throws Exception {
    File tokenFile = null;
