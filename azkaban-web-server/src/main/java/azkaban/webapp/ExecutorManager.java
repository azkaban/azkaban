...
public class ExecutorManager extends EventHandler implements
  ...
  public String submitExecutableFlow(final ExecutableFlow exflow, final String userId)
    ...
    synchronized (exFlowKey.intern()) {
      ...
      if (this.queuedFlows.isFull()) {
        ...
        exflow.setStatus(azkaban.executor.Status.PREPARING);
  ...
  private void dispatchContainer(final ExecutionReference reference, final ExecutableFlow exflow) throws ExecutorManagerException {
    ...
    try {
      ...
      String tonyAMResources = this.azkProps.getString(FlowContainerization.TONY_AM_RESOURCES, "/export/home/azkaban/test-dispatch/tony-core-0.3.23.jar,/export/home/azkaban/test-dispatch/tony-cli-0.3.23.jar,/export/home/azkaban/test-dispatch/tony-mini-0.3.23.jar,/export/home/azkaban/test-dispatch/tony-proxy-0.3.23.jar,/export/home/azkaban/test-dispatch/zip4j-1.3.2.jar,/export/home/azkaban/test-dispatch/jackson-core-2.8.11.jar,/export/home/azkaban/test-dispatch/jackson-databind-2.8.11.jar,/export/home/azkaban/test-dispatch/jackson-annotations-2.8.5.jar,/export/home/azkaban/test-dispatch/lib.zip#archive");
      final String executionStr = String.format("java -Dlog4j.configuration=file:./conf.zip/log4j.properties -cp ./lib.zip/*:/export/apps/hadoop/site/etc/hadoop:/export/apps/hadoop/latest/share/hadoop/common/lib/*:/export/apps/hadoop/latest/share/hadoop/common/*:/export/apps/hadoop/latest/share/hadoop/hdfs:/export/apps/hadoop/latest/share/hadoop/hdfs/lib/*:/export/apps/hadoop/latest/share/hadoop/hdfs/*:/export/apps/hadoop/latest/share/hadoop/yarn/lib/*:/export/apps/hadoop/latest/share/hadoop/yarn/*:/export/apps/hadoop/latest/share/hadoop/mapreduce/lib/*:/export/apps/hadoop/latest/share/hadoop/mapreduce/*:/export/apps/hadoop/site/lib/amf-sink-1.2.5-all.jar:/export/apps/hadoop/site/lib/grid-topology-1.0.jar:/export/apps/hadoop/site/lib/hadoop-lzo-0.4.20-SNAPSHOT.jar:./hive.zip/conf:./hive.zip/lib/* azkaban.container.FlowContainer basic_flow.zip %d jobTypeDir=jobtypes.zip lib.zip",
              exflow.getExecutionId());
      logger.info("executionStr = " + executionStr);
      int exitCode = submitter.submit(new String[] {FlowContainerization.TONY_CONF,
              ...
              FlowContainerization.TONY_CONF, String.join("=",FlowContainerization.TONY_AM_RESOURCES, tonyAMResources),
              FlowContainerization.TONY_EXECUTES, executionStr,
              ...
              FlowContainerization.TONY_CONF, String.join("=", FlowContainerization.TONY_OTHER_NAMENODES, "hdfs://ltx1-holdemnn02.grid.linkedin.com:9000"),
