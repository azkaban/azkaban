...
public class PodTemplateMergeUtils {
  ...
  /**
   * Combines pod metadata generated by the Azkaban code and obtained from an external pod spec
   * yaml file. Metadata from the external pod spec has precedence when resolving collisions.
   * @param podMetadata the metadata generated by the app code
   * @param podMetadataFromTemplate the metadata derived from external template pod spec.
   */
