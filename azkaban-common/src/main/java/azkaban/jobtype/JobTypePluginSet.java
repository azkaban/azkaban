...
public class JobTypePluginSet {
  ...
  private final List<String> defaultProxyUsersJobTypeClasses;
  // List of users which are not allowed as defaultProxyUsers
  private final List<String> defaultProxyUsersFilter;
  ...
  public JobTypePluginSet() {
    ...
    this.defaultProxyUsersJobTypeClasses = new ArrayList<>();
    this.defaultProxyUsersFilter = new ArrayList<>();
  }
  ...
  /**
   * @return The list of users which are not allowed as defaultProxyUsers.
   */
  public List<String> getDefaultProxyUsersFilter() {
   ...
   */
  public List<String> getDefaultProxyUsersJobTypeClasses() {
